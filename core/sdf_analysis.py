# -*- coding: utf-8 -*-
"""공유 코어 — SDF 스프링클러 배관망 분석 (파싱/인접/최단경로/집계).

core/dxf_geometry 의 _to_float 만 참조. golden 은 mod._analyze_sdf_sprinkler_network
모듈 속성으로 이 함수를 호출하므로 main 이 flat import 로 되가져온다.
"""
