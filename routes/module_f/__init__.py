...
from routes.module_f import api_convert, api_edit, api_open, api_pick
...
def register(app, *, _save_upload, UPLOAD_DIR):
    ...
    묶음마다 필요한 것만 받는다 — 업로드는 열기에서만, 산출물 폴더는 변환에서만
