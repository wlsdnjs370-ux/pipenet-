...
- 앵커 좌표 : `(763663.6300352641, 151498.4612808063)`
- 최원 유하거리 : 126.99 m
- 설계면적 폭 : 31.35 m
- corridor 총연장 : 177.34 m
- 주배관 담당 헤드 수(max_load) : 30
- 후보 헤드 : 619 / 도면 3,163
- **전개가 붙이지 못해 제외한 헤드 : 2,544**
...
| 선정 헤드 수 | 30 | 30 |  |
| **헤드 퍼짐 (대각, m)** | 33.5 | 134.1 | 작을수록 한 설계구역 — G 가 뭉친다 |
| 앵커 좌표 | (763663.6300352641, 151498.4612808063) | 없음 | A 비-anchored 경로엔 앵커 개념이 없다 |
| 최원 유하거리 (m) | 126.99 | — |  |
| max_load | 30 | — |  |
| corridor 총연장 (m) | 177.34 | 814.29 | A 는 흩어진 30개라 경로가 길다 |
| corridor 간선 수 | — | 148 |  |
