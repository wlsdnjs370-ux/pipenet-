...
(function () {
  ...
  // ★[2026-09-13] 선정이 «붙는 헤드» 만 고르게 되면서 첫 회에 전체망 전개를
  //   한 번 돈다(B1F 실측 88초 · 두 번째부터 0.3초 · 그만큼 표 확정이 1.8초로
  //   줄어 총합은 오히려 준다). 얼마나 걸릴지 말해 두지 않으면 «멈췄다» 로
  //   읽힌다 — 가림막 문구가 그 사실을 적는다.
  $("ed-worst").onclick = () => runWorst("최불리 헤드 선정 중… (큰 도면은 처음 한 번만 1~2분)");
