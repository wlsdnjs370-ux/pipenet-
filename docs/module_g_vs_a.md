...
| Pipe-type 구성 | (빈칸)(0) / KSD 3507(97) / KSD 3562(0) / KSD 3576(0) / DP(0) / CPVC2(0) / FX(0) | (빈칸)(0) / KSD 3507(148) / KSD 3562(0) / KSD 3576(0) / DP(0) / CPVC2(0) / FX_20A_216(30) |
| 노드 / 배관 / 노즐 | 98 / 97 / 30 | 209 / 178 / 30 |
| 좌표 폭 (x × y) | 3000 × 1045 | 3000 × 1707 |
| 배관 길이 합 (m) | 222.162 | 835.298 |
...
- [PASS] **위상 불변** — G9 이전(`9d581f8^`) 방출기 산출 `{'nodes': 98, 'pipes': 97, 'nozzles': 30, 'length_sum': 222.162}` / 지금 `{'nodes': 98, 'pipes': 97, 'nozzles': 30, 'length_sum': 222.162}`. 좌표 정규화와 아이소매트릭은 표시만 바꾼다는 증거다.
...
|---|---|---|---|
| 헤드 | 30 | 30 | 같음 |
| 최원 유하거리 (m) | 171.87 | 171.87 | 같음 |
| 설계면적 폭 (m) | 54.25 | 54.25 | 같음 |
| corridor 총연장 (m) | 207.31 | 207.31 | 같음 |
...
| 기기 | 0 | 0 | 같음 |
| 루프 잔여 | 0 | 0 | 같음 |
| 관경 근거 — 도면 텍스트 | 27 | 27 | 같음 |
| 관경 근거 — 별표1 보강 | 0 | 0 | 같음 |
| 관경 근거 — 별표1 폴백 | 70 | 70 | 같음 |
| 부속 | 56 | 56 | 같음 |
| 부속 판정 불가 | 3 | 3 | 같음 |
| 등가길이 미해결 | 0 | 0 | 같음 |
